...
### 中文
2026-06-03 飞书会议归档：将会议纪要沉淀为静态复盘页，便于检索、引用和后续整理。
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/2026-06-03-feishu-minutes-obcnzg28
- Live / 在线入口：https://siuserxiaowei.github.io/2026-06-03-feishu-minutes-obcnzg28/
...
```bash
git clone https://github.com/siuserxiaowei/2026-06-03-feishu-minutes-obcnzg28.git
cd 2026-06-03-feishu-minutes-obcnzg28
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnzg286uho3hs1t6d1db4y
- 模板：one_page
- 页面：`docs/index.html`
